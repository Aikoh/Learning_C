...
```
---
### 問題２ 次の仕様を満たしたプログラムを作りなさい。

1. 自分のデッキ5枚分の攻撃力とスキルをランダムに取得
2. スキルは、１、特大UP、２大UP、３中UP、４小UPの４種類
3. skillの係数は2倍、大UPは1.5倍、中UPは1.3倍、小UPは1.1倍
4. 自分のデッキはコンパイル時にランダムで5枚セットされる。
5. 勝敗を表示する。
